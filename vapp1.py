# pip install streamlit azure-storage-blob langchain_community langchain-google-genai docx PyPDF2 faiss-cpu numpy requests SpeechRecognition
...
def process_question(question_text):
    ...
    answer_placeholder.markdown(f"**Question:** {question_text}")
    answer_placeholder.markdown(f"**Answer:** {answer}")

# ==========================
# Layout: text input + voice button on same line
# ==========================
col1, col2 = st.columns([4,1])
with col1:
    question_text = st.text_input("Type your question here")
with col2:
    voice_clicked = st.button("🎤")  # microphone icon button
